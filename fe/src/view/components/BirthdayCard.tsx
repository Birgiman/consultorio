...
export function BirthdayCard() {
  return (
    <div className='w-full h-full'>
      ...
      <div className='flex flex-col justify-center w-full h-4/5 text-xl text-indian-khaki-900 tracking-wide bg-indian-khaki-400 rounded-b-xl border-x-[1.5px] border-y-[0.5px] border-indian-khaki-700'>
