...
export function Schedule() {
  return (
    <div className='w-full h-full bg-indian-khaki-300 rounded-xl flex'>
      <div className='rounded-2xl bg-indian-khaki-200 w-full my-8 mx-4 border-spectra-500 border-[1.5px]'>
